 ...
 * @author 朱亚杰 <zhuyajie@topthink.net>
 */
class AuthManagerController extends UserCenterController{
    ...
    public function index(){
        $list = $this->lists('AuthGroup',array('module'=>MODULE_NAME),'id asc');
    ...
    public function editGroup(){
        $auth_group = M('AuthGroup')->where( array('module'=>MODULE_NAME,'type'=>AuthGroupModel::TYPE_ADMIN) )
                                    ->find( (int)$_GET['id'] );
    ...
    public function access(){
        $this->updateRules();
        $auth_group = M('AuthGroup')->where( array('status'=>array('egt','0'),'module'=>MODULE_NAME,'type'=>AuthGroupModel::TYPE_ADMIN) )
                                    ->getfield('id,id,title,rules');
        
        $node_list   = $this->returnNodes();
        $map         = array('module'=>MODULE_NAME,'type'=>AuthRuleModel::RULE_MAIN,'status'=>1);
        $main_rules  = M('AuthRule')->where($map)->getField('name,id');
        $map         = array('module'=>MODULE_NAME,'type'=>AuthRuleModel::RULE_URL,'status'=>1);
