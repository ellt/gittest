...
class UserCenterController extends CommonBaseController {
    ...
    protected function relationLists ($model, $where=array(),$order='',$base = array('status'=>array('egt',0)),$field=true, $relation=true){
        $options    =   array();
        $REQUEST    =   (array)I('request.');
        ...
        return $model->relation($relation)->field($field)->select();
    }
